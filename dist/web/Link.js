...
var Link = (function (_super) {
    ...
    Link.prototype.render = function () {
        ...
        return (React.createElement("a", { style: this._getStyles(), title: this.props.title, href: this.props.url, target: '_blank', rel: 'noreferrer', onClick: this._onClick, onMouseEnter: this.props.onHoverStart, onMouseLeave: this.props.onHoverEnd, onMouseDown: this._onMouseDown, tabIndex: this.props.tabIndex }, this.props.children));
    };
