...
import { Accessibility as AccessibilityType } from '../native-common/Accessibility';
...
import { International as InternationalType } from '../native-common/International';
import { default as LinkImpl, Link as LinkType } from '../native-common/Link';
import { Linking as LinkingType } from '../native-common/Linking';
...
declare module ReactXP {
    ...
    var Input: InputType;
    type International = InternationalType;
    var International: InternationalType;
    type Link = LinkType;
