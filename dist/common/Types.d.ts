...
export interface NavigatorProps extends CommonProps {
    ...
    transitionStarted?: (progress?: RX.IAnimatedValue, toRouteId?: string, fromRouteId?: string, toIndex?: number, fromIndex?: number) => void;
...
export declare module Animated {
    ...
    type TimingFunction = (value: RX.IAnimatedValue, config: TimingAnimationConfig) => CompositeAnimation;
